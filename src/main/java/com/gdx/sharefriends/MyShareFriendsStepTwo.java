...
public class MyShareFriendsStepTwo {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(MyShareFriendsStepTwo.class);
		...
		FileInputFormat.setInputPaths(job, new Path("F:/testhadoop/sharefrendoutput/part-r-00000"));
		FileOutputFormat.setOutputPath(job, new Path("F:/testhadoop/out2"));
